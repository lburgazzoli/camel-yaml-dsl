...
class ConstructorResolverTest extends Specification {
    ...
    static class LocalResolver implements YamlDeserializerResolver {
        ...
        ConstructNode resolve(String id) {
            switch (id) {
                case 'my-node':
                case 'com.github.lburgazzoli.camel.dsl.yaml.common.ConstructorResolverTest$MyNode':
                    return new MyNodeConstructor();
                case 'nested':
                case 'com.github.lburgazzoli.camel.dsl.yaml.common.ConstructorResolverTest$MyNested':
        ...
        protected boolean setProperty(MyNode target, String propertyKey, String propertyName, Node value) throws Exception {
            switch (propertyKey) {
                case 'message':
                    ...
                    break
                case 'nested':
                    target.nested = YamlDeserializerSupport.asType(value, MyNested.class)
                    break
                default:
                    return false;
            }
