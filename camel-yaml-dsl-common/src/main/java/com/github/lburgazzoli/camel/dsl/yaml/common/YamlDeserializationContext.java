...
import com.github.lburgazzoli.camel.dsl.yaml.common.exception.UnknownNodeTypeException;
...
public class YamlDeserializationContext extends StandardConstructor implements CamelContextAware, Service {
    ...
    public void addResolvers(YamlDeserializerResolver... resolvers) {
        addResolvers(List.of(resolvers));
    }
    ...
    public ConstructNode mandatoryResolve(Node node) {
        ...
        if (constructor == null) {
            throw new YamlConstructException("Unable to find constructor for node: " + node);
        }
    ...
    public ConstructNode mandatoryResolve(String id) {
        ...
        if (constructor == null) {
            throw new YamlConstructException("Unable to find constructor for id: " + id);
        }
